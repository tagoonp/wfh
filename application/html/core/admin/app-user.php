...
<input type="hidden" id="txtRole" value="<?php echo $cuurentRole; ?>" class="form-control">
<head>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <div class="card">
                    <div class="pl-2 pt-2 pb-0">
                        <div class="row">
                            <div class="col-12 col-sm-2 text-white" style="padding-top: 4px;">Personnel rtype : </div>
                            <div class="col-12 col-sm-9 pl-0">
                                <div class="content-header-left col-4">
                                    <div class="breadcrumbs-top">
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-outline-secondary dropdown-toggle" id="btnPtype" type="button" id="dropdownMenuButtonSec" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                All
                                            </button>
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButtonSec">
                                                <a class="dropdown-item" href="javascript:admin.load_user_list('all');">All</a>
                                                <a class="dropdown-item" href="javascript:admin.load_user_list('admin');;">Admin</a>
                                                <a class="dropdown-item" href="javascript:admin.load_user_list('staff');;">Staff</a>
                                                <a class="dropdown-item" href="javascript:admin.load_user_list('common');;">Common</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
