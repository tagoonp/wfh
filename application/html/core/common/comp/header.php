                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name"><?php echo $currentUser['FNAME']." ".$currentUser['LNAME']; ?></span><span class="badge badge-success round user-status text-white" style="padding-top: 5px;"><?php echo $current_role; ?></span></div><span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0">
                                ...
                                <?php 
                                if($currentUser['WFH_ADMIN'] == 1){
                                    ?>
                                    <a class="dropdown-item" href="<?php echo ROOT_DOMAIN . '/controller/switch_role?to=admin'; ?>"><i class="bx bx-refresh mr-50"></i> Switch to admin</a>
                                    <a class="dropdown-item" href="<?php echo ROOT_DOMAIN . '/controller/switch_role?to=staff'; ?>"><i class="bx bx-refresh mr-50"></i> Switch to staff</a>
                                    <a class="dropdown-item" href="<?php echo ROOT_DOMAIN . '/controller/switch_role?to=common'; ?>"><i class="bx bx-refresh mr-50"></i> Switch to common</a>
                                    <?php
                                }else{
                                    if($currentUser['WFH_ADMIN'] == 1){
                                        ?>
