<div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                <li class=" nav-item  <?php if($page == 'home'){ echo "active"; }?>"><a href="./"><i class="menu-livicon" data-icon="home"></i><span class="menu-title text-truncate text-white" data-i18n="First page">หน้าแรก</span></a></li>
                ...
                <li class=" navigation-header text-truncate text-white"><span data-i18n="Support">อื่น ๆ</span></li>
                <li class=" nav-item"><a href="https://pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/documentation" target="_blank"><i class="menu-livicon" data-icon="morph-folder"></i><span class="menu-title text-truncate text-white" data-i18n="Documentation">Flowchart WFH SOP</span></a></li>
            </ul>
        </div>