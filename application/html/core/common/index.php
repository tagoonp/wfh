...
<body class="vertical-layout vertical-menu-modern dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
        ...
        <div class="content-wrapper mt-0">
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0 text-dark">แผน WFH ของคุณ</h5>
            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-body">
                        <?php 
                        $strSQL = "SELECT * FROM wfh_workplan WHERE plan_uid = '$uid' AND plan_delete = 'N' AND ((plan_status IN ('wait-approval', 'wait-edit', 'approved') AND plan_check != 'checked') OR plan_check IN ('wait-check', 'wait-update'))";
                        ...
                        if(($resPlan) && ($resPlan['status'])){
                            ...
                            <div class="text-center">
                                <img src="../../../img/error.png" alt="" width="200">
                                <p class="text-dark">
                                ไม่พบแผนการปฏิบัติงานที่บ้านของท่าน
                                </p>
                                <div>
                                    <button class="btn btn-danger"  data-toggle="modal" data-target="#modalRemark" >สร้างแผนที่นี่</button>
                                </div>
                            </div>
                            <?php
                        }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-0 text-dark">
                        เพื่อให้เป็นไปตามนโยบายการปฏิบัติงานที่บ้าน (Work From Home) ของสาขาวิชาระบาดวิทยา คณะแพทยศาสตร์ มหาวิทยาลัยสงขลานครินทร์  <span class="text-danger">ท่านจะต้องทำการคัดกรองและให้ข้อมูลก่อน</span> โดยการกดปุ่มด้านล่าง
                        <div class="pt-2">
                            <button class="btn btn-danger btn-block"  onclick="gonext()">
    ...
    <script>
        function gonext(){
            $('#txtC1').removeClass('dn')
            if($('#txtC1').val() == ''){
                $('#txtC1').addClass('is-invalid')
                return ;
            }
            window.location = 'app-assesment-create'
        }
    </script>
