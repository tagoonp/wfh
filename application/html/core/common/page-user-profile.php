...
require('../../../config/'.$_SESSION['doe_wfh_role'].'.php'); 
                                        ...
                                        <div class="col-12 col-sm-8 offset-sm-2">
                                            ...
                                            if(($currentUser['PHOTO'] != '') && ($currentUser['PHOTO'] != null)){
                                                if (@getimagesize($currentUser['PHOTO'])) {
                                                    ?>
                                                    <img class="round mb-1" src="<?php echo $currentUser['PHOTO']; ?>" alt="avatar" height="120" width="120">
                                                    <?php
                                                }else{
                                                    ?>
                                                    <img class="round mb-1" src="../../../app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="120" width="120">
                                                    <?php 
                                                }
                                            }else{
                                                ?>
                                            ...
                                            ?>
                                            <div class="pt-0 pb-0">
                                                <button class="btn btn-icon pl-1 pr-1 btn-secondary text-white btn-sm" style="border-radius: 50%; height: 50px; width: 50px; margin-top: -60px; margin-right: -120px;"><i class="bx bx-camera"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-8 text-dark d-none d-sm-block"><?php echo $currentUser['FNAME']." ".$currentUser['LNAME']; ?></div>
                                        <div class="col-12 col-sm-8 text-dark d-block d-sm-none pb-1" style="font-size: 1.5em;"><?php echo $currentUser['FNAME']." ".$currentUser['LNAME']; ?></div>
                                        <div class="col-12 col-sm-4">Personnal ID / ID</div>
                                        <div class="col-12 col-sm-8 text-dark d-none d-sm-block"><?php echo $currentUser['USERNAME']; ?></div>
                                        <div class="col-12 col-sm-8 text-dark d-block d-sm-none pb-1" style="font-size: 1.5em;"><?php echo $currentUser['USERNAME']; ?></div>

                                        <div class="col-12 col-sm-4">Position</div>
                                        <div class="col-12 col-sm-8 text-dark d-none d-sm-block">
                                            <?php 
                                            if(($currentUser['POSITION'] == null) || ($currentUser['POSITION'] == '')){
                                                echo "-";
                                            }else{
                                                echo $currentUser['POSITION'];
                                            }
                                            ?>
                                        </div>
                                        <div class="col-12 col-sm-8 text-dark d-block d-sm-none pb-1" style="font-size: 1.5em;">
                                            <?php 
                                            if(($currentUser['POSITION'] == null) || ($currentUser['POSITION'] == '')){
                                                echo "-";
                                            }else{
                                        ...
                                        <div class="col-12 col-sm-2 offset-sm-4">
                                            <div class="pt-1 pb-2">
                                                <button class="btn btn-icon- btn-danger btn-block btn-sm- pl-1 pr-2" style="padding-bottom: 8px;" onclick="authen.logout()">Sign out</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
