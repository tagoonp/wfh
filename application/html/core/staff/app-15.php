...
$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '15' AND rp_sending_status = '1' AND rp_confirm_1 = '1' AND rp_delete_status = '0' AND rp_progress_id = 'closing'";
$res6 = $db->fetch($strSQL, false);
if(($res6) && ($res6['cn'] > 0)){ $c_closing = $res6['cn']; }

$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '15' AND rp_sending_status = '1' AND rp_confirm_1 = '1'AND rp_delete_status = '0' AND rp_progress_id = 'terminate'";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <h3>โครงการที่รอนำเข้าที่ประชุม</h3>
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i></a></li>
                                <li class="breadcrumb-item active">โครงการที่รอนำเข้าที่ประชุม</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table class="table table-striped mt-3">
                                            ...
                                            <tbody>
                                                ...
                                                $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                            ...
                                                            WHERE 
                                                            a.rp_progress_status = '15' AND a.rp_sending_status = '1' AND a.rp_confirm_1 = '1' AND a.rp_delete_status = '0' AND a.rp_progress_id = 'closing'";
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: top;">
                                                                ...
                                                                <div style="padding-top: 5px;">
                                                                    <button class="btn btn-icon btn-success" style="padding-bottom: 10px; margin-top: 3px;" onclick="openForm('closing', '<?php echo $row['rp_id_rs'];?>', '<?php echo $row['rp_session'];?>')"><i class="bx bx-group"></i></button>
                                                                    <button class="btn btn-icon btn-success" style="padding-bottom: 10px; margin-top: 3px;" onclick="openNote('closing', '<?php echo $row['rp_session'];?>', '<?php echo $row['rp_session'];?>')"><i class="bx bx-menu"></i></button>
                                                                </div>
                                                            </td>
