...
$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '23' AND rp_sending_status = '1' AND rp_confirm_1 = '1' AND rp_delete_status = '0' AND rp_progress_id = 'closing'";
$res6 = $db->fetch($strSQL, false);
if(($res6) && ($res6['cn'] > 0)){ $c_closing = $res6['cn']; }

$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '23' AND rp_sending_status = '1' AND rp_confirm_1 = '1'AND rp_delete_status = '0' AND rp_progress_id = 'terminate'";
...
<body class="vertical-layout vertical-menu-modern dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
        ...
        <div class="content-wrapper p-0 p-sm-3">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1 pl-sm-1 pr-sm-1 pl-3 pr-3 pt-2 pt-sm-0">
                    <h3>โครงการที่อยู่ระหว่างนำเข้าที่ประชุม</h3>
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i></a></li>
                                <li class="breadcrumb-item active">โครงการที่อยู่ระหว่างนำเข้าที่ประชุม</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body" >
                <div class="card text-center">
                        <div class="card-body p-0 p-0 pl-sm-2 pr-sm-2 pt-sm-2">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane active show fade pb-3 pt-0" id="pills-closing" role="tabpanel" aria-labelledby="pills-closing-tab">
                                <?php 
                                    if($c_closing == 0){
                                        ?>
                                        <h4 class="card-title mt-0">ไม่มีแบบรายงานรอตรวจสอบ</h4>
                                        <?php
                                    }else{
                                        ?>
                                        ...
                                        <table class="table table-striped mt-0">
                                            ...
                                            <tbody>
                                                ...
                                                $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                            ...
                                                            WHERE 
                                                            a.rp_progress_status = '23' AND a.rp_sending_status = '1' AND a.rp_confirm_1 = '1' AND a.rp_delete_status = '0' AND a.rp_progress_id = 'closing'";
                                                    ...
                                                    foreach ($res['data'] as $row) {
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: top;">
                                                                ...
                                                                <div>
                                                                    <a href="app-report-info?id_rs=<?php echo $row['rp_id_rs'];?>&session_id=<?php echo $row['rp_session'];?>"><span class="text-white"><?php 
                                                                    if($row['title_th'] == '-'){
                                                                        echo $row['title_en'];
                                                                    }else{
                                        ...
                                        <table class="table table-striped mt-3">
                                            ...
                                            <tbody>
                                                ...
                                                $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                            INNER JOIN type_status_research c ON a.rp_progress_status = c.id_status_research
                                                            WHERE 
                                                            a.rp_progress_status = '23' AND a.rp_sending_status = '1' AND a.rp_confirm_1 = '1' AND a.rp_delete_status = '0' AND a.rp_progress_id = 'terminate'";
                                                $res = $db->fetch($strSQL, true, false);
                                                if(($res) && ($res['status'])){
                                                    foreach ($res['data'] as $row) {
                                                        ?>
    ...
    <script>
        ...
        function openForm(progress, id_rs, session){
            $('#txtIdrs').val(id_rs)
            $('#txtSessionId').val(session)
            $('#modalForm').modal()
        }

        function openNote(progress, session){
            $('#modalNote').modal()
        }
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">นำเข้าการประชุม</h5>
                ...
                <div class="modal-body">
                    <form onsubmit="return false;" id="research_approval_update">
                        <div class="form-group dn">
                            ...
                            <input type="text" class="form-control" id="txtIdrs" value="">
                        </div>
                        <div class="form-group dn">
                            <label for="">ครั้งที่ประชุม : <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="txtSessionId" value="">
                        </div>
                        <div class="form-group">
                            <label for="">ครั้งที่ประชุม : <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="txtMeeting" value="">
                        </div>
                        <div class="form-group">
                            <label for="">วาระ : <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="txtAganda" value="">
                        </div>
                        <?php 
                        $dd = ''; $mm = ''; $yy = '';
                        if($resRafa){
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary ml-1" onclick="approval.assignMeeting()">
