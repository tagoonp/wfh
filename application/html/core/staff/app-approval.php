            ...
            <div class="content-body" >
                <div class="card text-center">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <!-- <button class="btn btn-success"  data-toggle="modal" data-target="#exampleModalCenter" onclick="window.location='create_doc_<?php // echo $res_peport['rp_progress_id'] ;?>?id_rs=<?php // echo $id_rs; ?>&session_id=<?php // echo $session_id; ?>'"><i class="bx bx-plus mr-1"></i> สร้างเอกสารใบรับรอง/รับทราบ</button> -->
                                    <button class="btn btn-success"  data-toggle="modal" data-target="#modalApptype"><i class="bx bx-plus mr-1"></i> สร้างเอกสารใบรับรอง/รับทราบ</button>
                                        ...
                                        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalCenterTitle">เลือกประเภท</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <i class="bx bx-x"></i>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <button class="btn btn-success btn-block" onclick="window.location='create_doc_<?php echo $res_peport['rp_progress_id'] ;?>?id_rs=<?php echo $id_rs; ?>&session_id=<?php echo $session_id; ?>'">Closing</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-striped- mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ใบรับรองของรายงานหมายเลข</th>
                                            <th>วันที่สร้าง</th>
                                            <th>สถานะ</th>
                                            <th></th>
                                        </tr>
