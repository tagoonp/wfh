                        ...
                        <div class="row">
                            ...
                            <!-- <label for="iconLeft">Left Icon</label> -->
                                <fieldset class="form-group position-relative has-icon-left">
                                    <input type="text" class="form-control" id="txtSearchbox2" value="<?php echo $searchkey; ?>" placeholder="ใส่คำค้นหาที่นี่ เช่น รหัส REC หรือ ชื่อ นามสกุล ของนักวิจัย แล้วก enter" />
