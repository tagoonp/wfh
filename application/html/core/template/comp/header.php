                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0">
                                ...
                                if($currentUser['wfh_admin'] == 1){
                                    ?>
                                    <a class="dropdown-item" href="../admin/"><i class="bx bx-refresh mr-50"></i> Switch to admin</a>
                                    <a class="dropdown-item" href="../staff/"><i class="bx bx-refresh mr-50"></i> Switch to staff</a>
                                    <a class="dropdown-item" href="../common/"><i class="bx bx-refresh mr-50"></i> Switch to common</a>
                                    <?php
                                }else{
                                    if($currentUser['wfh_staff'] == 1){
                                        ?>
                                        <a class="dropdown-item" href="../staff/"><i class="bx bx-refresh mr-50"></i> Switch to staff</a>
                                        <a class="dropdown-item" href="../common/"><i class="bx bx-refresh mr-50"></i> Switch to common</a>
                                        <?php
